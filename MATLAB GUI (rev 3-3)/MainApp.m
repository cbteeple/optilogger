...
freq = num2str(y);
freqdash='------';
freqdash(1:length(freq))=freq;

fprintf(handles.s,'%c',['FREQ',freqdash]);
...
if get(hObject,'Value')
    fprintf(handles.s,'%c','TRIGON');
else
    fprintf(handles.s,'%c','TRIGOFF');
end
